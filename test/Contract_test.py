...
class ContractTestCase(unittest.TestCase):
    ...
    def test_name_delete_beneficiary(self):
        ...
        self.test_contract.add_beneficiary('mock preexistence')
        self.test_contract.add_beneficiary('mock preexistence 2')
        self.test_contract.add_beneficiary('mock preexistence 3')
